<template>
    <div>
        ...
        <div class="steps-content">
            <div v-if="current == 0">
                <div>
                    <a-typography-title :level="3">Select your account you want to run boost <a-tag color="orange" style="font-size: 18px;font-weight: bold;">Like Tweet</a-tag> </a-typography-title>
